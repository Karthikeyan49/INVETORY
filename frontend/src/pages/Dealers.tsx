              ...
              <TabsContent value="inventory">
                <div className="bg-muted/30 rounded-lg p-4 space-y-3 text-sm max-h-[50vh] overflow-y-auto">
                  ...
                  {!reservationLoading && reservationSummary && (
                    <>
                      <div className="flex justify-between items-center">
                        <span className="text-muted-foreground">Actual Reserved Stock</span>
                        <span className="text-card-foreground font-semibold">{reservationSummary.total_actual_reserved ?? 0}</span>
                      </div>
                      <div className="border-t border-border" />
                      <div className="flex justify-between items-center">
                        <span className="text-muted-foreground">Suggested Reserve (predicted)</span>
                        <span className="text-card-foreground font-medium">{reservationSummary.total_suggested_reserve}</span>
                      </div>
                      <div className="border-t border-border" />
                      <div className="flex justify-between items-center">
                      ...
                      {reservationSummary.items.map((item) => (
                        <div key={item.inv_product_id} className="border rounded-lg p-3 space-y-1.5 bg-card">
                          ...
                          <div className="flex justify-between text-xs">
                            <span className="text-muted-foreground">Actual Reserved (physical)</span>
                            <span className="text-card-foreground font-medium">{item.actual_reserved_qty ?? 0}</span>
                          </div>
                          <div className="flex justify-between text-xs">
            ...
            <div className="w-full space-y-2 text-sm">
              ...
              <div className="flex items-center gap-2 bg-muted/50 rounded-lg px-3 py-2.5">
                ...
                <div className="text-left">
                  ...
                  <p className="font-medium text-card-foreground">admin@inventory.com</p>
                </div>
              </div>
            </div>
