// GST state codes — the first 2 digits of a GSTIN encode the state.
// Shared by invoicing and quotation→invoice conversion so both derive the
// place of supply / inter-vs-intra-state split the same way.
