...
let MOCK_EMPLOYEES: Employee[] = [
  { id: "EMP-001", name: "Arun Prakash", email: "arun@inventory.in", phone: "+91 98400 11122", department: "Production", designation: "Shift Supervisor", baseSalary: 32000, joinedAt: "2023-04-12", qrToken: "INV-AP-001-7Q9X", active: true },
  { id: "EMP-002", name: "Divya Ramesh", email: "divya@inventory.in", phone: "+91 98400 22334", department: "Quality", designation: "QC Engineer", baseSalary: 38000, joinedAt: "2022-11-05", qrToken: "INV-DR-002-K2M4", active: true },
  { id: "EMP-003", name: "Karthik S", email: "karthik@inventory.in", phone: "+91 99520 11445", department: "Dispatch", designation: "Logistics Lead", baseSalary: 28000, joinedAt: "2024-01-18", qrToken: "INV-KS-003-B8N1", active: true },
  { id: "EMP-004", name: "Meena Lakshmi", email: "meena@inventory.in", phone: "+91 90030 55778", department: "Sales", designation: "Field Sales", baseSalary: 26000, joinedAt: "2023-09-22", qrToken: "INV-ML-004-Z3P7", active: true },
  { id: "EMP-005", name: "Suresh Kumar", email: "suresh@inventory.in", phone: "+91 90420 88991", department: "Maintenance", designation: "Mechanical Tech", baseSalary: 30000, joinedAt: "2022-06-30", qrToken: "INV-SK-005-V6T2", active: true },
];
...
const genToken = (name: string) => {
  ...
  return `INV-${initials}-${String(MOCK_EMPLOYEES.length + 1).padStart(3, "0")}-${rand}`;
};
