...
class AuthController
{
    ...
    public function refresh(Request $request): void
    {
        try {
            ...
            Database::execute('DELETE FROM refresh_tokens WHERE id = ?', [(int) $stored['id']]);
    ...
    public function sendOtp(Request $request): void
    {
        ...
        if ($type === 'email') {
            @mail(
                $identifier,
                'Your Inventory Management System Verification OTP',
    ...
    private function issueTokenPairForClient(int $userId, string $clientType): array
    {
        ...
        $access  = JWT::encode(['sub' => $userId, 'type' => 'access',  'client' => $clientType], $accessExpiry);
        $refresh = JWT::encode(['sub' => $userId, 'type' => 'refresh', 'client' => $clientType], $refreshExpiry);
    ...
    {
        $subject = "Account Approved - Welcome to Inventory Management System!";
        $message = "
            <!DOCTYPE html>
            <html>
            <head>
            ...
            <body>
                <div class='container'>
                    ...
                    <div class='content'>
                        <h2>Hello {$name},</h2>
                        <p><strong>Great news!</strong> Your Inventory Management System account has been approved.</p>
                        <p>You can now log in to the app using your registered email and password.</p>
                        <p style='text-align: center;'>
                            <a href='#' class='button'>Open Inventory Management System App</a>
                        </p>
        ...
        $message = "
            ...
            <body>
                <div class='container'>
                    ...
                    <div class='content'>
                        <h2>Hello {$name},</h2>
                        <p>Thank you for your interest in Inventory Management System.</p>
    ...
    private function sendEmail(string $to, string $subject, string $message): void
    {
        ...
        $headers = [
            ...
            'Reply-To: support@inventory.com',
