...
class AdminQueryController
{
    ...
    public function reply(Request $request): void
    {
        ...
        if (!empty($adminReply) && !empty($query['email'])) {
            $to      = $query['email'];
            $subject = 'Re: ' . ($query['subject'] ?? 'Your Query to Inventory Management System');
            ...
            <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; border: 1px solid #e5e7eb; border-radius: 8px; padding: 20px;">
                <h2 style="color: #10b981;">Inventory Management System</h2>
                ...
                <p>Best regards,<br>The Inventory Management System Team</p>
                <hr style="border: none; border-top: 1px solid #e5e7eb; margin: 20px 0;">
                <p style="margin:0;color:#9ca3af;font-size:12px;text-align:center;">© Inventory Management System · This is an automated message, please do not reply to this email directly.</p>
            </div>';

            $headers  = "MIME-Version: 1.0\r\n";
            $headers .= "Content-Type: text/html; charset=UTF-8\r\n";
            $headers .= "From: Inventory Management System Support <noreply@inventory.com>\r\n";
