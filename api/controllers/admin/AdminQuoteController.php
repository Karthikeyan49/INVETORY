...
class AdminQuoteController
{
              ...
              <table width="520" cellpadding="0" cellspacing="0" style="background:#ffffff;border-radius:12px;overflow:hidden;box-shadow:0 2px 8px rgba(0,0,0,.08);">
                ...
                <tr>
                  <td style="padding:32px 36px;">
                    ...
                    <p style="margin:0 0 24px;color:#4b5563;font-size:14px;line-height:1.6;">Dear {$name},<br><br>Thank you for your interest in Inventory Management System biomass solutions. We have reviewed your request and are pleased to provide you with a custom quote.</p>
                    ...
                    <p style="margin:20px 0 4px;color:#4b5563;font-size:14px;">To place an order or ask any questions, reply to this email or contact us at <a href="mailto:support@inventory.com" style="color:#16a34a;">support@inventory.com</a>.</p>
                    <p style="margin:0;color:#4b5563;font-size:14px;">Best regards,<br>The Inventory Management System Team</p>
                  </td>
                </tr>
                <tr>
                  <td style="background:#f9fafb;padding:16px 36px;border-top:1px solid #e5e7eb;">
                    <p style="margin:0;color:#9ca3af;font-size:12px;">© Inventory Management System · This is an automated message, please do not reply directly.</p>
                  </td>
                </tr>
              </table>
            </td></tr>
    ...
    public function update(Request $request): void
    {
        ...
        if ($uiStatus === 'Quoted' && !empty($quotedPrice) && !empty($quote['email'])) {
            ...
            $subject   = 'Your Custom Quote from Inventory Management System';
