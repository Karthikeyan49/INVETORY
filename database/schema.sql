-- ============================================================================
-- Consolidated schema — all tables + ONE bootstrap admin login (no demo data).
-- Generated by database/build-schema.sh. Do not edit by hand.
-- Import into an EMPTY database (e.g. via phpMyAdmin → Import).
-- ============================================================================
SET SQL_MODE='NO_AUTO_VALUE_ON_ZERO';
SET FOREIGN_KEY_CHECKS=0;
SET NAMES utf8mb4;
-- Target database. It must already exist (create it in hPanel → MySQL first).
-- This line removes the need to pre-select a database when importing.
USE `u952547820_inventory`;

-- ── Core schema: base tables only (no data, no procedures/views) ───────────
-- phpMyAdmin SQL Dump
-- version 5.2.2
-- https://www.phpmyadmin.net/
--
-- Host: 127.0.0.1:3306
-- Generation Time: Jun 29, 2026 at 05:52 AM
...
--
-- Dumping data for table `historical_invoices`
--
...
--
-- Dumping data for table `historical_invoice_items`
--
...
--
-- Dumping data for table `import_job_rows`
--
...
--
ALTER TABLE `attendance`
  MODIFY `attendance_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=666;
...
--
ALTER TABLE `employee_advances`
  MODIFY `advance_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=16;
...
--
ALTER TABLE `expenses`
  MODIFY `expense_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=340;
...
--
ALTER TABLE `historical_invoices`
  MODIFY `historical_invoice_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=582;

--
-- AUTO_INCREMENT for table `historical_invoice_items`
--
ALTER TABLE `historical_invoice_items`
  MODIFY `item_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=628;
...
--
ALTER TABLE `import_job_rows`
  MODIFY `row_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=736;
...
--
ALTER TABLE `inventory_products`
  MODIFY `inv_product_id` int(11) NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `otp_verifications`
  MODIFY `otp_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=136;
...
--
ALTER TABLE `payroll`
  MODIFY `payroll_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=1104;
...
-- ── Bootstrap admin login (created during rebrand; the ONLY user row) ──────
INSERT IGNORE INTO users (name, email, phone, password_hash, user_type, staff_role, approval_status, is_active)
VALUES ('Administrator', 'admin@inventory.kynetropo.com', '', '$2y$12$8UMtC4vfzjpMWnjBz7fyFOFsSkHy2KB9VpUP09ke0L/Zccc9/I.tC', 'admin', 'owner', 'approved', 1);

-- ── Brand color (from rebrand config → app/sidebar/ID-card theme) ──────────
INSERT IGNORE INTO settings (setting_key, setting_value) VALUES ('company_primary_color', '#2563eb');
